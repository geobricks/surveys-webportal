if (!window.B) {
	...
	window.B = {
		...
		build : function(id) {
			...
			s += "<td><input type='text' class='text-input' size='45' id='question_" + id + "' style='height: 23px;'/></td>";
			...
			s += "<td><input type='text' class='text-input' size='45' id='info_" + id + "' style='height: 23px;'/></td>";
			s += "<td></td>";
			s += "</tr>";
			s += "<tr>";
			...
			s += "<td><input type='text' class='text-input' size='45' id='indicator_" + id + "' style='height: 23px;'/></td>";
			s += "<td></td>";
			s += "</tr>";
			s += "</table>";
			s += "</td>";
